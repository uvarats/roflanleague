 ...
 */
final class Version20230414173928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE challonge_token (id INT NOT NULL, related_user_id INT NOT NULL, access_token TEXT NOT NULL, refresh_token TEXT NOT NULL, access_token_expires_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE discipline (id INT NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(30) NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE tourney (id INT NOT NULL, discipline_id INT DEFAULT NULL, name VARCHAR(30) NOT NULL, impact_coefficient DOUBLE PRECISION NOT NULL, challonge_url VARCHAR(255) NOT NULL, state VARCHAR(75) DEFAULT \'new\' NOT NULL, is_ranked BOOLEAN NOT NULL, description TEXT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE tourney_invite (id INT NOT NULL, tourney_id INT NOT NULL, slug VARCHAR(50) NOT NULL, is_active BOOLEAN NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D824059D989D9B62 ON tourney_invite (slug)');
